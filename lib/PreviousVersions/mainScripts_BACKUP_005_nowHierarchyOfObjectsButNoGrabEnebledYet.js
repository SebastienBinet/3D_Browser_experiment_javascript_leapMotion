...
//            "children": "null"
        },
        {
            ...
            "initialPositionOnParent": {"x": "-0.75", "y": "0.00", "z": "-0.75", "scale": "1"},
//            "children": "null"
        },
        {
            "URI": "null",   // non-leaf node
...
//    newElement.ThreeJsObjectInScene.scale.set(0.1, 0.1, 0.1);
...
//        scene.add( gridLine );
    } else if ((element.type == "3DContainer" || element.type == "3DLink" ) && (element.model3D && element.model3D.modelKind == "hardCodedFourSpheres")) {
        ...
        if(element.initialPositionOnParent.scale) {
            retThreeJsComplexObject.scale.x = element.initialPositionOnParent.scale * 0.25;
            retThreeJsComplexObject.scale.y = element.initialPositionOnParent.scale * 0.25;
            retThreeJsComplexObject.scale.z = element.initialPositionOnParent.scale * 0.25;
        }
